...
#ifndef CORE_PERIPHERAL_SCB_SCB_PRIVATE_H_
#define CORE_PERIPHERAL_SCB_SCB_PRIVATE_H_
...
#define RESET_SYSTEM_REQUESI							0X05FA0004UL
...
#endif /* CORE_PERIPHERAL_SCB_SCB_PRIVATE_H_ */
